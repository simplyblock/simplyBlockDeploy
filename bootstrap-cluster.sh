...
for node in ${storage_private_ips}; do
    ...
    sbcli-dev storage-node add-node --cpu-mask 0x3 --memory 8g --iobuf_small_pool_count 10000 --iobuf_large_pool_count 25000 --iobuf_small_bufsize 10000 --iobuf_large_bufsize 25000 \$CLUSTER_ID \${node}:5000 eth0
    sleep 5
done
"

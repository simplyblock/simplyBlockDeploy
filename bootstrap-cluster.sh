...
print_help() {
    ...
    echo "  --cap-warn <value>                   Set Capacity warning level in percent (optional)"
    echo "  --cap-crit <value>                   Set Capacity critical level in percent (optional)"
    echo "  --prov-cap-warn <value>              Set Provision Capacity warning level in percent (optional)"
    echo "  --prov-cap-crit <value>              Set Provision Capacity critical level in percent (optional)"

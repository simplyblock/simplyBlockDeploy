...
variable "storage_nodes_distro" {
  ...
  validation {
    condition     = contains(["rhel9", "rocky10", "ubuntu2404", "ubuntu2204", "talos"], var.storage_nodes_distro)
    error_message = "The distribution type must be either 'rhel9', 'rocky10', 'ubuntu2404', 'ubuntu2204' or 'talos'."
  }
}
